...
gulp.task('concat-css', function(){//en este caso el orden de los archivos si altera el resultado, se va a concatenar todos los css 
    return gulp.src(['www/css/styles.css'])//primero concatena normalize, luego skeleton y por último styles
        .pipe(concatCss('styleM.css'))//el pipe cocatCss me va a renombrar el nuevo archivo
...
gulp.task('minify-css', ['concat-css'], function(){
  return gulp.src('www/css/styleM.css')
    .pipe(cssmin())
